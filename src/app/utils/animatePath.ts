import { EXDENTED_SLEEP_TIME, PATH_TILE_STYLE, SLEEP_TIME, SPEEDS, TRAVERSED_TILE_STYLE } from "./constants";
...
export const animatePath = (
    ...
    setTimeout(() => {
        for(let i=0;i<path.length; i++){
            ...
            }, EXDENTED_SLEEP_TIME * i * SPEEDS.find((s) => s.value===speed)!.value)
        }
